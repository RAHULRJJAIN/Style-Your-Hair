...
def get_im_paths_not_embedded(im_paths: Set[str]) -> List[str]:
    ...
    for im_path in im_paths:
        assert os.path.isfile(im_path), f"File not found: {im_path}"  # Add this line to check if the file exists
...
if __name__ == "__main__":
    ...
    parser.add_argument('--im_path1', type=str, default='Source.png', help='Identity image')
    parser.add_argument('--im_path2', type=str, default='Target.png', help='Structure image')
